...
int	Nx, Ny, Nz,  				/*Number of grid knots in x & z directions)*/
	verbose_level;

float	dx, dy, dz, dxy;			/*Horizontal & vertical grid intervals [m]*/


char	version[LENGTHVERS], 			/*Version of the program*/
	version_input[LENGTHVERS];		/*Version actually found in input files*/


BOOL	switch_geograph_coor,			/*1 if x-y are geographycal coordinates in decimal degrees*/
